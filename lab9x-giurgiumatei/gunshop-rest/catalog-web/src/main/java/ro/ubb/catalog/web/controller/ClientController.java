...
public class ClientController {
    ...
    public List<ClientDto> getAllClients() {
        ...
        logger.trace("getClients: clients={}", clients);
    ...
    List<ClientDto> getAllClientsBornBefore(@PathVariable @DateTimeFormat(pattern = "d-M-yyyy") LocalDate date) {
//        return new ClientsDto(
//                clientConverter.convertModelsToDtos(
//                    clientService.getAllClientsBornBefore(date)));
        logger.trace("getClients");

        List<Client> clients = clientService.getAllClientsBornBefore(date);

        logger.trace("getClients: clients={}", clients);

        return new ArrayList<ClientDto>(clientConverter.convertModelsToDtos(clients));
    }
}
